...
const Untitled3 = () => {
  return <View style={_styles.UePKGgME}>
      <ImageBackground style={_styles.NvGxGqjI} source={{
    ...
    }} resizeMode="cover"></ImageBackground><Text style={_styles.TlJXMfLb}>Lorem ipsum…</Text></View>;
};
